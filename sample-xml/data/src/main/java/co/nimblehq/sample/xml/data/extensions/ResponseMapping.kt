package co.nimblehq.sample.xml.data.extensions

import co.nimblehq.sample.xml.data.response.ErrorResponse
import co.nimblehq.sample.xml.data.response.toModel
import co.nimblehq.sample.xml.data.service.providers.MoshiBuilderProvider
import co.nimblehq.sample.xml.domain.exceptions.ApiException
import co.nimblehq.sample.xml.domain.exceptions.NoConnectivityException
