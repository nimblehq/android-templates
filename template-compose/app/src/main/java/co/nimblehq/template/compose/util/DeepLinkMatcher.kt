@file:Suppress("ComplexMethod", "ReturnCount", "NestedBlockDepth")
 ...
 * [co.nimblehq.template.compose.ui.screens.MainActivity.deepLinkPatterns] to enable deep link
 * handling.
 *
...
internal class DeepLinkMatcher<T : Any>(
    ...
    fun match(): DeepLinkMatchResult<T>? {
        ...
        if (!matchQueryArgs(args)) return null
    ...
    private fun matchQueryArgs(args: MutableMap<String, Any>): Boolean {
