...
class MainActivity : ComponentActivity() {
     ...
     * Example:
     * ```
     * DeepLinkPattern(HomeDestination.serializer(), Uri.parse("https://example.com/home"))
     * ```
     */
    internal val deepLinkPatterns: List<DeepLinkPattern<out Any>> = listOf(
        DeepLinkPattern(ListDestination.serializer(), Uri.parse("https://example.com/list"))
    )
