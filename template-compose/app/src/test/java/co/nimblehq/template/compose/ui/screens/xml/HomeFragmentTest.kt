package co.nimblehq.template.compose.ui.screens.xml

import co.nimblehq.template.compose.R
import co.nimblehq.template.compose.databinding.FragmentHomeBinding
import co.nimblehq.template.compose.test.TestNavigatorModule.mockMainNavigator
import co.nimblehq.template.compose.test.getPrivateProperty
import co.nimblehq.template.compose.test.replace
import co.nimblehq.template.compose.ui.BaseFragmentTest
